...
neutrino-release-base:
	...
	install -d $(RELEASE_DIR)/usr/lib/tuxbox
...
#
	if [ -e $(TARGET_DIR)/share/fonts/ubuntu-l-webfont.ttf ]; then \
		...
		if [ -e $(TARGET_DIR)/share/fonts/tuxtxt.ttf ]; then \
			cp -aR $(TARGET_DIR)/share/fonts/tuxtxt.ttf $(RELEASE_DIR)/share/fonts; \
			ln -s /share/fonts/tuxtxt.ttf $(RELEASE_DIR)/share/fonts/DejaVuLGCSansMono-Bold.ttf; \
		fi; \
	fi
#
# neutrino
