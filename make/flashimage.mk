...
#HD51_BOXMODE_1_MEM = brcm_cma=440M@328M brcm_cma=192M@768M
#HD51_BOXMODE_12_MEM = brcm_cma=520M@248M brcm_cma=200M@768M
#HD51_BOXMODE_12_MEM = brcm_cma=520M@248M brcm_cma=192M@768M
...
#	echo "boot emmcflash0.kernel1 '$(HD51_BOXMODE_1_MEM) root=/dev/mmcblk0p3 rw rootwait $(BOXTYPE)_4.boxmode=1'" > $(HD51_BUILD_TMP)/STARTUP
#	echo "boot emmcflash0.kernel1 '$(HD51_BOXMODE_1_MEM) root=/dev/mmcblk0p3 rw rootwait $(BOXTYPE)_4.boxmode=1'" > $(HD51_BUILD_TMP)/STARTUP_1
#	echo "boot emmcflash0.kernel2 '$(HD51_BOXMODE_1_MEM) root=/dev/mmcblk0p5 rw rootwait $(BOXTYPE)_4.boxmode=1'" > $(HD51_BUILD_TMP)/STARTUP_2
#	echo "boot emmcflash0.kernel3 '$(HD51_BOXMODE_1_MEM) root=/dev/mmcblk0p7 rw rootwait $(BOXTYPE)_4.boxmode=1'" > $(HD51_BUILD_TMP)/STARTUP_3
#	echo "boot emmcflash0.kernel4 '$(HD51_BOXMODE_1_MEM) root=/dev/mmcblk0p9 rw rootwait $(BOXTYPE)_4.boxmode=1'" > $(HD51_BUILD_TMP)/STARTUP_4
#	echo "boot emmcflash0.kernel1 '$(HD51_BOXMODE_12_MEM) root=/dev/mmcblk0p3 rw rootwait $(BOXTYPE)_4.boxmode=12'" > $(HD51_BUILD_TMP)/STARTUP_1_12
#	echo "boot emmcflash0.kernel2 '$(HD51_BOXMODE_12_MEM) root=/dev/mmcblk0p5 rw rootwait $(BOXTYPE)_4.boxmode=12'" > $(HD51_BUILD_TMP)/STARTUP_2_12
#	echo "boot emmcflash0.kernel3 '$(HD51_BOXMODE_12_MEM) root=/dev/mmcblk0p7 rw rootwait $(BOXTYPE)_4.boxmode=12'" > $(HD51_BUILD_TMP)/STARTUP_3_12
#	echo "boot emmcflash0.kernel4 '$(HD51_BOXMODE_12_MEM) root=/dev/mmcblk0p9 rw rootwait $(BOXTYPE)_4.boxmode=12'" > $(HD51_BUILD_TMP)/STARTUP_4_12
