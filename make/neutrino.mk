...
$(D)/neutrino-alpha.config.status:
	...
	cd $(N_OBJDIR); \
		...
		$(BUILDENV) \
		$(SOURCE_DIR)/neutrino-alpha/configure \
			--enable-silent-rules \
			--build=$(BUILD) \
			--host=$(TARGET) \
			$(N_CONFIG_OPTS) \
...
$(D)/neutrino-test.config.status:
	...
	cd $(N_OBJDIR); \
		...
		$(BUILDENV) \
		$(SOURCE_DIR)/neutrino-test/configure \
			--enable-silent-rules \
			--build=$(BUILD) \
			--host=$(TARGET) \
			$(N_CONFIG_OPTS) \
...
$(D)/neutrino-current.config.status:
	...
	cd $(N_OBJDIR); \
		...
		$(BUILDENV) \
		$(SOURCE_DIR)/neutrino-current/configure \
			--enable-silent-rules \
			--build=$(BUILD) \
			--host=$(TARGET) \
			$(N_CONFIG_OPTS) \
...
$(D)/neutrino-matze.do_prepare: | $(NEUTRINO_DEPS) $(D)/libstb-hal-ddt
	$(START_BUILD)
...
$(D)/neutrino-matze.config.status:
	...
	cd $(N_OBJDIR); \
		...
		$(BUILDENV) \
		$(SOURCE_DIR)/neutrino-matze/configure \
			--enable-silent-rules \
			--build=$(BUILD) \
			--host=$(TARGET) \
			$(N_CONFIG_OPTS) \
...
PHONY += $(SOURCE_DIR)/neutrino-alpha/src/gui/version.h
PHONY += $(SOURCE_DIR)/neutrino-test/src/gui/version.h
PHONY += $(SOURCE_DIR)/neutrino-current/src/gui/version.h
PHONY += $(SOURCE_DIR)/neutrino-matzte/src/gui/version.h
