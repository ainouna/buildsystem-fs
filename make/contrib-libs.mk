...
#	install -D -m 0600 $(SKEL_ROOT)/etc/lcd4linux_own.conf $(TARGET_DIR)/etc/lcd4linux.conf
	install -D -m 0600 $(SKEL_ROOT)/etc/lcd4linux_bp.conf $(TARGET_DIR)/etc/lcd4linux.conf
	$(REMOVE)/lcd4linux-git-$(LCD4LINUX_VER)
	$(TOUCH)
